              ...
              <form action="add-product" method="POST" enctype="multipart/form-data">
                <div class="input-product">
                  ...
                  <div class="input-fields">
                    <input class="field" type="text" placeholder="Product Name" name="name" required />
                    <input class="field" type="number" placeholder="Product Price (VND)" name="price" required />
                    ...
                    <input class="input-product-btn btn-submit " type="submit" value="Save" />
                  </div>
                </div>
              </form>
            </div>
