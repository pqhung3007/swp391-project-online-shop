            ...
            <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
              <c:forEach var="category" items="${categories}">
                <li class="nav-item" role="presentation">
                  <a href="listProducts?categoryId=${category.categoryId}" class="nav-link active">
              ...
              <c:forEach var="product" items="${products}">
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="product">
                    ...
                    <p><a href="productDetail?pid=${product.productId}" class="btn btn-primary rounded-pill">View
                        Product</a></p>
                  </div>
                </div>
              </c:forEach>
