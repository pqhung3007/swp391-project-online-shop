<%-- Document : sign Created on : Jun 3, 2022, 9:50:53 AM Author : Admin --%>
                                ...
                                <div class="row img-twice position-relative h-100">
                                    ...
                                    <div class="col-6 align-self-end">
                                        <img class="img-fluid rounded"
                                            src="phan-biet-8-loai-thuc-uong-ca-phe-hot-nhat-hien-nay-6.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-floating">
                                                    <input type="text" class="form-control text-primary" id="name"
                                            ...
                                            <div class="col-12">
                                                <div class="gradient-border" id="box"></div>
                                                <div class="form-floating">
                                                    <input type="password" class="form-control text-primary" id="name"
