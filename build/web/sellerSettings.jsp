                ...
                <%@include file="components/sidebarSeller.jsp" %>
                    <div class="container-settings">
                        <div class="container-info">
                            <p class="container-title">If you are new to this account, please fill in all fields in this form to update personal
                                info</p>
                        ...
                        <div class="container-account">
                            <p class="container-title">Remember to set a strong password to avoid unauthorized access</p>
